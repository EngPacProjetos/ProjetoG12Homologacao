function servicetask325(attempt, message) {
    ...
    while (true) {
        var sufixo = "___" + i;
        var codtrbN = hAPI.getCardValue("impostos_selecao_municipal_sub" + sufixo);

        if (codtrbN == null || codtrbN == "" || codtrbN == "null" || codtrbN == undefined) break;

        var aliqN = hAPI.getCardValue("aliquotaMunicipalSub" + sufixo);
        var reduN = hAPI.getCardValue("baseReucaoMunicipalSub" + sufixo);
