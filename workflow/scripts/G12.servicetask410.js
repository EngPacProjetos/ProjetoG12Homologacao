function servicetask410(attempt, message) {
    ...
    function servicetask404(attempt, message) {
        ...
        var idmovMovimento02 = hAPI.getCardValue("historico2201").split(",").pop().trim();
        ...
        log.info("### INICIANDO SERVIÇO DE ATUALIZAÇÃO DE HISTÓRICO NO RM 2.2.01###");
        ...
        try { /* */ var servico = ServiceManager.getService("wsDataServer");
            ...
            log.info("[G12-AJUSTAR-HISTORICO] Resultado historico 2.2.01" + ": " + resultado);
