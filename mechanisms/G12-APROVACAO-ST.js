...
function getUser(CentroDeCusto, CodColigada) {
	...
	if (CodColigada == 2) {
		if (CentroDeCusto == '02.01.01.01.005' || CentroDeCusto == '02.01.01.01.009' || CentroDeCusto == '02.02.01.05.001') {
			...
			|| CentroDeCusto == "02.02.01.01.024" || CentroDeCusto == "02.02.01.01.025") {
			userList.add('bbe0cc93-5544-472a-9632-e60de59733c3');//odijerfeson
		} /*else if (CentroDeCusto == "02.01.01.01.004") {
			...
			|| CentroDeCusto == "02.03.01.01.009" || CentroDeCusto == "02.03.01.01.014") {
			userList.add('d60eeee8-9923-482a-a272-4340ab578415');//lucas.vinicius
		} /*else if(CentroDeCusto == "02.03.01.01.002" || CentroDeCusto == '02.03.01.01.003'){
			userList.add('be7dedbb-0e9c-4a23-97d4-db0d85b50a5a')//aryfran
		...
		} else if (CentroDeCusto == '02.06.01.04.002' || CentroDeCusto == '02.06.01.0sergio4.003' || CentroDeCusto == '02.06.01.04.004' || CentroDeCusto == '02.06.01.04.005' || CentroDeCusto == '02.06.01.04.006') {
			userList.add('0f50eb1b-7ef5-4e3a-b3f1-1a2186f7695f')//Rodrigo Medeiros
		...
		else if (CentroDeCusto == "02.05.01.01.008" || CentroDeCusto == "02.05.01.01.009" || CentroDeCusto == "02.05.01.01.010"
		) {
		...
		if (CentroDeCusto == "02.02.01.01.008" || CentroDeCusto == "02.02.01.01.009") {
			...
			CentroDeCusto == "02.04.01.01.019" || CentroDeCusto == "02.04.01.01.020" || CentroDeCusto == '02.04.01.01.023') {
			userList.add('70f0fe39-f805-4a44-a44a-dc52cabc626a');//diego
			...
			userList.add('fdbc23c0-649a-4928-8394-38baba8950ca')// Vanylk
		} else if (CentroDeCusto == "02.04.01.01.008" || CentroDeCusto == "02.04.01.01.021" || CentroDeCusto == "02.04.01.01.022"
			|| CentroDeCusto == "02.02.01.01.005" || CentroDeCusto == "02.04.01.01.015" || CentroDeCusto == "02.04.01.01.016" || CentroDeCusto == "02.04.01.01.017" || CentroDeCusto == "02.04.01.01.018") {
			userList.add('d60eeee8-9923-482a-a272-4340ab578415');//lucas.vinicius
		...
		// else if (CentroDeCusto == "02.01.01.01.014"
		// ) {
		// 	userList.add('1c293b39-2a52-435a-a72b-d5ff21f4cd16');//leonardo.bezerra
		// } 
			...
			CentroDeCusto == "02.01.01.01.038" || CentroDeCusto == "02.07.01.01.001") {
		...
		} else if (CentroDeCusto == '02.05.01.01.004' || CentroDeCusto == '02.05.01.01.005') {
			userList.add('fdbc23c0-649a-4928-8394-38baba8950ca');// Vanylk Souza
		} else if (CentroDeCusto == '02.05.01.01.006') {
			userList.add('26f66aed-fca4-4edc-a375-8679412a7ba7');//Jos�?© Emanuel
		} else if (CentroDeCusto == "02.05.01.02.003") {
			userList.add('a2808599-f0c1-46b4-89d4-634074ffc7a4')//Tercio Porto
		} else if (CentroDeCusto == '02.05.01.03.001' || CentroDeCusto == '02.05.01.03.002') {
			userList.add('67fe6fd1-b2aa-4047-93f1-b32539c4b26e'); // matheus.brito
		}
		else {
			userList.add('4ef20412-7687-40a4-b1c8-095c0a92503e');//Fluig
		}
