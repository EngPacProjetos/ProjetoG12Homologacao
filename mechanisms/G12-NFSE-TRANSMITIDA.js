...
function getGroup(CentroDeCusto, CodColigada){
	...
	if(CodColigada == 2){
			userList.add('Pool:Group:G12-ENGPAC-NFSE-TRANSMITIDA');
	} else if(CodColigada == 1) {
			userList.add('Pool:Group:G12-GENNESIS-NFSE-TRANSMITIDA');
	} else if(CodColigada == 3){
			userList.add('Pool:Group:G12-ECONTECX-NFSE-TRANSMITIDA');
	} else  {
