...
function getGroup(CentroDeCusto, CodColigada){
	...
	if(CodColigada == 2){
			userList.add('Pool:Group:G12-ENGPAC-AJUSTE-FINANCEIRO');
	} else if(CodColigada == 1) {
			userList.add('Pool:Group:G12-GENNESIS-AJUSTE-FINANCEIRO');
	} else if(CodColigada == 3){
			userList.add('Pool:Group:G12-ECONTECX-AJUSTE-FINANCEIRO');
	} else  {
